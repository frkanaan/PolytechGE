...
int main(void)
{
	...
	while (1)
	{
		...
		if (joined_flags == 1)
		{
			...
			if ((MAC_COMMAND_ANS_status == 1 && response_level == 3) || (unconfirmed_downlink_data_ans_status == 1 && is_there_data == 1 && response_level == 1) || (confirmed_downlink_data_ans_status == 1 && is_there_data == 1 && response_level == 2) || (((MAC_COMMAND_ANS_status == 1) || (confirmed_downlink_data_ans_status == 1 && is_there_data == 1)) && (response_level == 4)) || (((MAC_COMMAND_ANS_status == 1) || (is_there_data == 1)) && (response_level == 5)))
			{
				if (((LoRaMacState & 0x00000001) != 0x00000001) && ((LoRaMacState & 0x00000010) != 0x00000010))
				{
					MAC_COMMAND_ANS_status = 0;
